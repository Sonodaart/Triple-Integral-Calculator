...
- Case $B<0 \land C<0$:
	...
	We proceed to write $r>-Ax^2-ax-By^2-by-Cz^2-cz$. With this, since we know that $A,B,C<0$ we can change notation once a gain absorbing the signs into the coefficients getting $A\equiv -A,a\equiv -a, ...$ $A\equiv -A, ...$. $A\equiv -A,a\equiv -a$ $A\equiv -Aa\equiv -a ...$
